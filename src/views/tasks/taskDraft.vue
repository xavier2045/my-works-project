  ...
  <div class="taskList">
    ...
    <div class="taskList-container">
      <div class="taskList-content">
        <div class="taskList-content-main" data-aos="fade-up">
            ...
            <template #item="{ items }">
              <wc-waterfall :gap="30" :cols="4">
                <div 
                  ...
                  @click="toTaskDetail(item.id, index)"
                >
...
<script lang='ts' setup>
  ...
  import { missionsDraftOList } from '@/api/task';
  ...
  const fetchNews = async (page: number) => {
      ...
      console.log(getData);
      try {
        const response = await missionsDraftOList(getData);
  ...
  // 点击任务详情
  const toTaskDetail = async (id: string) => {
    userInfo.taskDraftId = id;
    userInfo.openPostAtaskType = 2;
    router.push({ name: 'PostATask'});
  };
