                          ...
                          <div class="time-select">
                            <div class="daoAdmin">
                              <div class="daoAdmin-avatar">
                                <el-image
                                  :src="progressData.adminUserAvatar"
                                  fit="cover"
                                >
                                  <template #error>
                              ...
                              <div class="daoAdmin-name">任务责任人</div>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="module-footer">
                    <div class="module-footer-content">
                      <div class="content-btn">
                        <template v-if="userInfo.id == progressData.adminUserId">
                          <div
                    ...
                    <div class="select-user">
                      <div class="user-content">
                        ...
                        <div class="user-info">
                          <div class="userName multi-line-1">{{ progressData.adminUsername }}</div>
                          <div class="userUuid multi-line-1">{{ progressData.adminUserUuid }}</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="main-body-content-footer">
                <div class="footer-content">
                  <div class="content-data-list">
                    ...
                    <div 
                      class="content-data-list-bg ctt_big_bg"
                    >
                      <div class="list-item-main">
                        <div class="filterList-selece">
                          <div
                            class="list-item-main-content list-item-main-content-two"
...
import { debug } from 'console';
  ...
  const ctt = ref(1); // 1 大任务发布者查看个人，2 大任务发布者查看全部，3 Dao管理员查看所有，4 子任务发布者查看个人， 5 路人查看全部, 6 个人任务管理员查看
  ...
  const carouselSlides = ref(
    [
      {
        avatar: 'https://wang-1259575362.cos.ap-guangzhou.myqcloud.com/2024/12/30/1735531118701-img4.jpeg',
        name: '推荐任务一',
        id: 1,
        type: 0
      },
      {
        avatar: 'https://wang-1259575362.cos.ap-guangzhou.myqcloud.com/2024/12/30/1735531117689-img5.jpeg',
        name: '推荐任务二',
        id: 2,
        type: 0
      },
      {
        avatar: 'https://wang-1259575362.cos.ap-guangzhou.myqcloud.com/2024/12/30/1735546314111-img7.jpeg',
        name: '推荐任务三',
        id: 3,
        type: 0
      }
  ...
  const finFilterListFun = (item: any, index: number) => {
    ...
    userInfo.arAdminUserId = progressData.value.adminUserId
  };
  ...
  const updateKbContent = (newContent: any) => {
    ...
    if(ismoduleType.value == 1) {
      ...
      if(userInfo.id == userInfo.bigTaskUserId) {
        ...
        newContent.businessType = 3;
      } else if(userInfo.id == progressData.value.adminUserId) {
        ctt.value =6;
        nodeType.value = 1;
        newContent.businessType = 3;
        newContent.businessId = missionId.value;
      }
    }
