              ...
              <div class="kb-from">
                  <div class="kb-from-content">
                      <div class="proposal-from-header">
                          ...
                          <div class="proposal-from-header-text">意见反馈</div>
                      </div>
                      ...
                      <div class="kb-from-content-footer">
                          <div class="kb-from-content-footer-btn" @click="uploadToCOS">立即提交</div>
                      </div>
                  </div>
              </div>
          </div>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
      ...
      const delUrls = ref([]);
      const nodePeriodSort = ref(userInfo.nodePeriodSort);
      const nodeDataSort = ref(userInfo.nodeDataSort);
      const canlpload = ref(userInfo.canlpload);
                                  ...
                                  .kb-from-info-content-flie{
                                      ...
                                      .flie-content{
                                          ...
                                          .flie-upload{
                                              ...
                                              :deep(.upload-style-icon){
                                                i{
                                                  line-height: 65px;
                                                }
                                              }
                                              :deep(.upload-style-text){
